<%-- 
    Document   : courseAdd
    Created on : May 24, 2017, 6:30:48 PM
    Author     : VegetaPC
--%>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control border-input" placeholder="Nhập tên khoá học" name="course_name"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="10" class="form-control border-input" placeholder="Nhập nội dung khoá học" name="course_content"></textarea>
                                                </div>
                                            </div>
                                        </div>
